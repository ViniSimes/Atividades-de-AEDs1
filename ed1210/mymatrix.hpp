...
class Matrix
{
   ...
   Matrix ( T initial, int rows = 0, int columns=0 )
   {
      // definir dado local
      bool OK = true;
   ...
   Matrix& operator= ( const Matrix <T> other )
   {
      ...
      else
      {
         ...
         for ( int x=0; this->rows; x++ )
         {
            for ( int y=0; this->columns; y++ )
            {
