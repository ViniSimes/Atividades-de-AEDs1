...
void method01( )
{
   ...
   //identificar
   IO_id ("EXEMPLO0301 - Method1 - v0.0");
...
/**
 Method02 - Repetir com teste no inicio
*/
void method02( )
{
   //definir dado
...
void method03( )
{
   ...
   //ler teclado
   x = IO_readint("Entrar com uma quatidade: ");
...
void method04( )
{
   ...
   //encerrar
   IO_pause("Apertar ENTER para continnuar");
}//end method04( )


/**
  Method05 - Repeticao com teste no inicio variacao
*/
void method05( )
{
   //definir dado
...
void method07 ( )
{
   ...
   //ler teclado
   IO_printf("Entrar com uma palvra: ");
   scanf ("%s", palavra);
...
void method09( )
{
   ...
   superior = IO_readdouble( "Limite superior do intervelo" );
...
void method10( )
{
   ...
   //ler do teclado
   inferior = IO_readdouble( "Limite infeiror do intervalo: " );
   ...
   //repitir ate' hafirmacao de validade
   do
   {
      passo = IO_readdouble( "Variacao no intervalo(passo)" );
   } 
