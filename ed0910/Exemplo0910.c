...
copyIntMatrix - Copiar matriz com valores inteiros
  @param rows      - quantidade de valores
  @param caolumns  - quantidade de valores
  @param matrix    - grupo de valores inteiros
*/
...
isIdentity - Testar se matriz identidade
  ...
  @param rows    - quantidade de valores
  @param columns - quantidade de valores
  @param matrix  - grupo da valores inteiros  
*/
...
/**
Method02 - Ler 4 valores e posicionar em matriz
*/
void method02 ( )
{
  //definir dados
...
/**
Method04 - Mostrar dados do arquivo ja salvo
*/
void method04 ( )
{
  //definir dados
...
/**
Method07 - Testar se matriz identidade
*/
void method07 ( )
{
  //definir dados
...
/**
Method08 - Testar se matrizes sao iguais
*/
void method08 ( )
{
  //definir dados
...
/**
Method09 - Somar matrizes com inteiros
*/
void method09 ( )
{
  // definir dados
...
int main ( )
{
  ...
  {
    // identificar
    IO_id ( "EXEMPLO0910 - Programa - v0.0" );

    // ler do teclado
    IO_println ( "Opcoes" );
    IO_println ( " 0 - parar" );
    IO_println ( " 1 - mostrar certa quantidade de valores" );
    IO_println ( " 2 - Gravar 4 valores e posicionar em matriz" );
    IO_println ( " 3 - Gravar arranjo bidimensional e mostrar em matriz" );
    IO_println ( " 4 - Mostrar dados do arquivo ja salvo" );
    IO_println ( " 5 - Copiar matrix" );
    IO_println ( " 6 - Transpor matrix" );
    IO_println ( " 7 - Testar se matriz identidade" );
    IO_println ( " 8 - Testar se matrizes sao iguais" );
...
Teste    Versao    Resultado      Atualizacao
 1.0       0.1       (OK)        printIntMatrix     || method01
 2.0       0.1       (OK)        readIntMatrix      || method02
 3.0       0.1       (OK)        fprintIntMatrix    || method03
 4.0       0.1       (OK)        freadMatrixRows
                                 freadMatrixColumns
                                 freadIntMatrix     || method04
 5.0       0.1       (OK)        copyIntMatrix      || method05
 6.0       0.1       (OK)        transposeIntMatrix || method06
 7.0       0.1       (OK)        isIdentity         || method07
 8.0       0.1       (OK)        isEqual            || method08
 9.0       0.1       (OK)        addIntMatrix       || method09
 10.0      0.1       (OK)        addIntMatrix       || method10
*/